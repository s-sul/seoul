  ...
  <FORM name='frm' method='POST' action='./login.do' class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        ...
        <input type='text' class="form-control" name='mem_id' id='mem_id' value='${ck_id }' required="required" style='width: 30%;' placeholder="아이디" autofocus="autofocus">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        ...
        <input type='password' class="form-control" name='mem_pw' id='mem_pw' value='${ck_passwd }' required="required" style='width: 30%;' placeholder="패스워드">
