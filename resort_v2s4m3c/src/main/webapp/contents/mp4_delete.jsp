...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <ASIDE style='float: left;'>
    ${categrpVO.name } > ${cateVO.name } > ${contentsVO.title} 관련 MP4 삭제
  </ASIDE>
  ...
  <DIV style='width: 100%;'>
    <FORM name='frm' id='frm' method='POST' action='./mp4_delete.do' 
      ...
      <div class="form-group">   
        <div class="col-md-12">
          <DIV style='width:640px; margin: 0px auto;'>
            등록된 MP4를 삭제 하시겠습니까? 삭제된 파일은 복구 할 수 없습니다.<br>
            관련글명: ${contentsVO.title}<br>
            파일명: ${contentsVO.mp4}<br>
          </DIV>
        </div>
      </div>
